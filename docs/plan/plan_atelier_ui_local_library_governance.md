...
- 后续可拆 `docs/plan/plan_gui_motion_foundation.md`，用于真正实现 motion tokens / animation driver。
- 后续可拆 `docs/plan/plan_atelier_ui_self_painted_widget_intake.md`，用于某个具体自绘控件的参考调研、TDD、用户审查和入库流程。
