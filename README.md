...
下一步适合继续沿 adapter 链补 `output.export` / ArtifactFinalizer、ASR/OCR/Translate Agent 前置 adapter 规划，或在 GUI 侧接入只触发后端 queue 的最小工作流运行入口。
