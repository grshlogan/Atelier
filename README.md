...
- [docs/WORKCANVAS_PREVIEW_ARTIFACT_SPEC.md](./docs/WORKCANVAS_PREVIEW_ARTIFACT_SPEC.md)：WorkCanvas preview artifact、thumbnail cache、ComfyUI 借鉴边界和节点卡片矢量化路线。
- [docs/plan/gui_workbench/README.md](./docs/plan/gui_workbench/README.md)：GUI / AtelierUI / 控件画板 / UI 打磨计划入口和归档规则。
- [docs/plan/gui_workbench/plan_main_interactive_gui_workbench.md](./docs/plan/gui_workbench/plan_main_interactive_gui_workbench.md)：交互式 GUI 工作台主计划，拆分 Workflow Canvas、Execution Canvas、Queue Monitor、Inspector、workspace 和 motion 后续方向。
- [docs/plan/gui_workbench/plan_atelier_ui_component_workbench.md](./docs/plan/gui_workbench/plan_atelier_ui_component_workbench.md)：`AtelierUI` 控件画板计划，用于候选自绘控件入库前的参数调试、状态展示和用户审查。
- [docs/plan/gui_workbench/plan_atelier_ui_workflow_canvas_node_cards.md](./docs/plan/gui_workbench/plan_atelier_ui_workflow_canvas_node_cards.md)：`AtelierUI` Workflow Canvas 节点卡片候选目录计划，当前候选是 `VideoInputCard`。
...
- [atelier/gui/ui/README.md](./atelier/gui/ui/README.md)：`AtelierUI` 本地专属 UI 基础库说明，当前覆盖 theme tokens、自绘控件入库 checklist、dev-only component workbench 和 Workflow Canvas 节点卡片候选目录。
