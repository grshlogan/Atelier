...
- [atelier/assets/README.md](./atelier/assets/README.md)：当前软件 SVG 图标库说明，覆盖 toolbar、navigation、nodes、queue、hardware、status、inspector 和 system 图标资源。
...
下一步适合继续推进 Scheduler runner 接线前置边界，或在你细化视觉后继续推进 GUI 只读面板的数据丰富度与 panel visibility / preset UI。
